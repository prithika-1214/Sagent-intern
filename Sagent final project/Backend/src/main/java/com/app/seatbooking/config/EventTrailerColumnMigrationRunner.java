...
@Component
public class EventTrailerColumnMigrationRunner implements ApplicationRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(EventTrailerColumnMigrationRunner.class);
    private static final String COLUMN_NAME = "trailer_url";
    private final JdbcTemplate jdbcTemplate;

    public EventTrailerColumnMigrationRunner(JdbcTemplate jdbcTemplate) {
    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            if (eventsTable == null || eventsTable.isBlank() || hasTrailerColumn(eventsTable)) {
                return;
            }
    ...
    private boolean hasTrailerColumn(String tableName) {
