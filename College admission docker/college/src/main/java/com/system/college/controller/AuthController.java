...
public class AuthController {
    ...
    public String registerStudent(@RequestBody Student student) {
        if (officerRepo.findByEmail(student.getEmail()).isPresent()) {
        ...
        if (existingStudent.isPresent()) {
            ...
            String existingPassword = dbStudent.getPassword();
    ...
    public String registerOfficer(@RequestBody Officer officer) {
        if (studentRepo.findByEmail(officer.getEmail()).isPresent()) {
            return "Email already exists!";
        }

        Optional<Officer> existingOfficer = officerRepo.findByEmail(officer.getEmail());
        if (existingOfficer.isPresent()) {
            Officer dbOfficer = existingOfficer.get();
            String existingPassword = dbOfficer.getPassword();
            if (existingPassword == null || existingPassword.isBlank()) {
                dbOfficer.setName(officer.getName());
