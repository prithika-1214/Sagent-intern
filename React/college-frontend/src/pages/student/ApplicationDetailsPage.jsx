...
import { formatDate, formatDateOrDateTime, formatDateTime } from "../../utils/date";
          ...
          <Stack spacing={2}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <Typography>{formatDate(application.dob || application.user?.dob || application.student?.dob)}</Typography>
              </Grid>
              <Grid size={{ xs: 12, md: 6 }}>
                <Typography variant="subtitle2" color="text.secondary">
                  Course
                  ...
                  {payments.map((payment) => (
                    <ListItem key={payment.paymentId}>
                      <ListItemText
                        ...
                        secondary={`Status: ${payment.status} | Date: ${formatDateOrDateTime(
