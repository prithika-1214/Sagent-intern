...
export default function Navbar() {
  ...
  const isStore = isAuthenticated && role === ROLES.STORE;
  const isDeliveryAgent = isAuthenticated && role === ROLES.DELIVERY_AGENT;
  const hideShoppingLinks = isStore || isDeliveryAgent;
